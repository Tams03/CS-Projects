...
Welcome! This portfolio displays a selection of projects I did during my computer science degree, demonstrating firsthand experience in **Python development, IoT, data analysis, deep learning, and web applications**. 

Each project includes **full documentation, demos, project files, and reflections**. The projects were completed both **individually and in groups**, giving me experience in **collaboration, full-stack development, and real-world problem solving**.
...
**Project Type:** Group Project | **Role:** Backend (FastAPI/WebSocket), model integration (NLLB-200), testing  
...
## 🧰 Tools & Technologies
- **Programming & Analysis:** Python, OpenCV, Pyzbar, YouTube API, NLLB-200, FastAPI, WebSocket, Pandas, Matplotlib  
- **Web & Mobile:** Flutter, Firebase, Pyrebase, Streamlit  
- **Hardware & IoT:** Raspberry Pi  
- **Development & Collaboration:** Git, GitHub, Colab Notebooks, Figma, Canva
...
3. Follow instructions in demos, scripts, or notebooks to run the projects and try them out  
