...
Welcome! This portfolio showcases a curated selection of my Computer Science projects, demonstrating hands-on experience in **Python development, IoT, data analysis, deep learning, and web applications**.  

Each project includes **full documentation, demos, project files, and reflections**, presented in a consistent portfolio style. The projects were completed both **individually and in groups**, giving me experience in **collaboration, full-stack development, and real-world problem solving**.
...
- **Development & Collaboration:** Git, GitHub, Colab Notebooks, Figma  
